...
/// All information needed to generate Csharp (C#) type-code
#[derive(Default)]
pub struct Csharp {
    /// Mappings from Rust type names to Csharp type names
...
impl Language for Csharp {
    ...
    fn format_special_type(
        ...
        match special_ty {
            ...
            SpecialRustType::Unit => Ok("void".into()),
            SpecialRustType::String => Ok("string".into()),
            SpecialRustType::Char => Ok("char".into()),
            SpecialRustType::I8 => Ok("sbyte".into()),
            SpecialRustType::U8 => Ok("byte".into()),
            ...
            SpecialRustType::I54 | SpecialRustType::U53 => Ok("U54".into()),
    ...
    fn write_enum(&mut self, w: &mut dyn Write, e: &RustEnum) -> io::Result<()> {
        ...
        match e {
            ...
            RustEnum::Algebraic { shared, .. } => {
                write!(w, "using {}{} = ", shared.id.renamed, generic_parameters)?;
...
impl Csharp {
    ...
    fn write_field(
        ...
        let ts_ty: String = match field.type_override(SupportedLanguage::Csharp) {
        ...
        let nullable = field.ty.is_optional() || field.has_default;
